...
public:
  ...
  // member function for getting values of x, y:
  int Get_X() const;
  int Get_Y() const;
...
// class constructor sets X and Y to zero when no values are specified:
Point::Point()
{
  X = 0;
  Y = 0;
...
// Declaration of point with coordinates X = 2, Y = 3:
  Point p2(2, 3);
